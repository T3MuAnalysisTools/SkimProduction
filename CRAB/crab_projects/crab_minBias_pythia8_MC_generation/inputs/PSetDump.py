...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('MinBias_13TeV_cfi.py nevts:50'),
...
process.g4SimHits = cms.EDProducer("OscarMTProducer",
    ...
    HFShowerLibrary = cms.PSet(
        ...
        FileName = cms.FileInPath('SimG4CMS/Calo/data/HFShowerLibrary_npmt_noatt_eta4_16en_v4.root'),
    ...
    StepVerboseThreshold = cms.double(0.1),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(20971520),
    fileName = cms.untracked.string('file:MinBias_13TeV_SIM.root'),
    outputCommands = cms.untracked.vstring( ('drop *', 
        'drop *', 
        'drop *', 
        'keep  FEDRawDataCollection_rawDataCollector_*_*', 
